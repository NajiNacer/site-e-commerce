<footer class="page-footer">
    <div class="container footer-info">
        <div class="row">
            <div class="col s12 l4 ">
                ...
                <ul>
                    <li><a class="grey-text text-lighten-3 animated slideInUp wow" href=""> Nacer NAJI</a></li>
                </ul>
            </div>
            <div class="col s12 l4 ">
    ...
    <div class="footer-copyright">
        <div class="container">
            © <?= Date('Y'); ?> Copyright
            <a class="grey-text text-lighten-4 right animated slideInUp wow">Nacer Naji</a>
        </div>
    </div>
</footer>
